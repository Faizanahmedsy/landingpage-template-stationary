  ...
  return (
    <footer className="border-t border-slate-100 bg-white py-12">
      <div className="max-w-7xl mx-auto px-4 text-center">
        <p className="font-black text-xl text-lumina-dark mb-4">Lumina Store</p>
        ...
        <p className="text-slate-400 text-sm">© {new Date().getFullYear()} Lumina General Store. All rights reserved.</p>
      </div>
    </footer>
  );
};